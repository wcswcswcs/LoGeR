...
class ScanNetPPDataset:
    ...
    def __init__(self, seq_name, seg_model) -> None:
        ...
        self.root2 = f'./data/scannetpp/data/{seq_name}'
        self.root2 = self.root

        if seg_model == 'Cropformer':
            self.segmentation_dir = f'{self.root2}/output_Cropformer/mask'
            self.object_dict_dir = f'{self.root2}/output_Cropformer/object'
        if seg_model == 'SAM2':
            self.segmentation_dir = f'{self.root2}/output_SAM2/mask'
            self.object_dict_dir = f'{self.root2}/output_SAM2/object'
