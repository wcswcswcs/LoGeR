...
cd "$STREAM3D"
mkdir -p logs outputs/audit/v9_o33_o31_boundary_refine outputs/v9_boundary_refine data/evaluation/scannet
...
eval_own() {
  local config="$1"
  run_logged "logs/stream4d_v9_o33_${config}_eval.log" \
...
cross_eval() {
  ...
  local eval_policy="$4"
  run_logged "logs/stream4d_v9_o33_${output_config}.log" \
    "$PY" -m tools.evaluate_cross_prepoints \
      ...
      --audit-root outputs/audit/v9_o33_o31_boundary_refine \
      --require-manifest \
...
refine_eval() {
  ...
  local policy="$3"
  run_logged "logs/stream4d_v9_o33_${output_config}_refine.log" \
...
run_logged logs/stream4d_v9_o33_o31_boundary_refine_py_compile.log \
  "$PY" -m py_compile \
...
refine_eval stream4d_v9_o33_o31_noexcl_refine_inside050_probe5 0.50 own_boundary_refine_o31_noexcl_inside050
refine_eval stream4d_v9_o33_o31_noexcl_refine_inside035_probe5 0.35 own_boundary_refine_o31_noexcl_inside035

run_logged logs/stream4d_v9_o33_o31_boundary_refine_matrix_probe5.log \
  "$PY" -m tools.summarize_v9_unified_eval \
    --root . \
    --seq-list splits/scannet_v6_probe5.txt \
    --matrix-json scripts/v9_o33_o31_boundary_refine_matrix_probe5.json \
    --output-prefix outputs/audit/v9_o33_o31_boundary_refine/o33_o31_boundary_refine_matrix_probe5 \
    --dataset scannet \
    --stream3d-config scannet

run_logged logs/stream4d_v9_o33_o31_boundary_refine_reportable_scan.log \
  "$PY" -m tools.scan_reportable_configs \
    --root . \
    --configs stream4d_v9_o33_o31_noexcl_refine_inside050_probe5,stream4d_v9_o33_o31_noexcl_refine_inside035_probe5 \
    --output outputs/audit/v9_o33_o31_boundary_refine/reportable_config_scan_o33_probe5.md \
    --require-manifest \
    --require-eval-policy

run_logged logs/stream4d_v9_o33_o31_boundary_refine_metric_integrity.log \
  "$PY" -m tools.verify_stream4d_metric_integrity \
    --orig-stream3d-root . \
    --current-root . \
    --configs stream4d_v9_o33_o31_noexcl_refine_inside050_probe5,stream4d_v9_o33_o31_noexcl_refine_inside035_probe5 \
    --seq-list splits/scannet_v6_probe5.txt \
    --output outputs/audit/v9_o33_o31_boundary_refine/metric_integrity_o33_probe5.md \
    --require-manifest

echo "v9 O33 O31-boundary-refine cross-support done"
