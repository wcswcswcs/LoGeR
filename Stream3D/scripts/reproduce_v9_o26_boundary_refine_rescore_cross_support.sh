...
cd "$STREAM3D"
mkdir -p logs outputs/audit/v9_o26_boundary_refine_rescore outputs/v9_score_calibration data/evaluation/scannet
...
eval_own() {
  local config="$1"
  run_logged "logs/stream4d_v9_o26_${config}_eval.log" \
...
cross_eval() {
  ...
  local eval_policy="$4"
  run_logged "logs/stream4d_v9_o26_${output_config}.log" \
    "$PY" -m tools.evaluate_cross_prepoints \
      ...
      --audit-root outputs/audit/v9_o26_boundary_refine_rescore \
      --require-manifest \
...
rescore_eval() {
  ...
  local policy="$3"
  run_logged "logs/stream4d_v9_o26_${output_config}_rescore.log" \
...
run_logged logs/stream4d_v9_o26_boundary_refine_rescore_py_compile.log \
  "$PY" -m py_compile \
...
rescore_eval stream4d_v9_o25_o23_refine_inside050_probe5 stream4d_v9_o26_o25_inside050_logarea_probe5 own_recompute_score_calibration_o26_inside050_logarea
rescore_eval stream4d_v9_o25_o23_refine_inside070int010_probe5 stream4d_v9_o26_o25_inside070int010_logarea_probe5 own_recompute_score_calibration_o26_inside070int010_logarea

run_logged logs/stream4d_v9_o26_boundary_refine_rescore_matrix_probe5.log \
...
run_logged logs/stream4d_v9_o26_boundary_refine_rescore_reportable_scan.log \
...
run_logged logs/stream4d_v9_o26_boundary_refine_rescore_metric_integrity.log \
...
echo "v9 O26 boundary-refine rescore cross-support done"
