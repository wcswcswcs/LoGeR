'''
    This script extracts open-vocabulary visual features for each mask following OpenMask3D and MaskClustering.
...
def main():
    ...
    for seq_name in args.seq_name_list.split('+'):
        ...
        # print(backbone)
        dataset = get_dataset(args, backbone)
    ...
    print('Average CLIP time', (start_time_1 - start_time_0) / count, 'sec')
