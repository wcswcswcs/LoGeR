#!/usr/bin/env python3
"""Build and summarize R78 stronger risk-suppress refinements for seq08."""
...
STAGE = RESULT_ROOT / "stage4_r78_lingbot_ar_fresh_stronger_risk_source_refinement_08"
...
METHOD_SPECS = [
    {
        "role": "leaveout3_g1p25",
        "method": "lingbot_map_stream_sdpa_v118_r78_fresh_leaveout3_g1p25_seq08",
        "policy": "R78_FRESH_LEAVEOUT3_G1P25",
        "source_frames": (0, 1, 2, 4, 5),
        "token_weight_mode": "risk_suppress_only_g1p25_x_frame",
    },
    {
        "role": "leaveout3_g1p5",
        "method": "lingbot_map_stream_sdpa_v118_r78_fresh_leaveout3_g1p5_seq08",
        "policy": "R78_FRESH_LEAVEOUT3_G1P5",
        "source_frames": (0, 1, 2, 4, 5),
        "token_weight_mode": "risk_suppress_only_g1p5_x_frame",
    },
    {
        "role": "leaveout3_g2",
        "method": "lingbot_map_stream_sdpa_v118_r78_fresh_leaveout3_g2_seq08",
        "policy": "R78_FRESH_LEAVEOUT3_G2",
        "source_frames": (0, 1, 2, 4, 5),
        "token_weight_mode": "risk_suppress_only_g2_x_frame",
    },
    {
        "role": "leaveout35_base",
        "method": "lingbot_map_stream_sdpa_v118_r78_fresh_leaveout35_base_seq08",
        "policy": "R78_FRESH_LEAVEOUT35_BASE",
        "source_frames": (0, 1, 2, 4),
        "token_weight_mode": "risk_suppress_only_x_frame",
    },
    {
        "role": "leaveout35_g1p25",
        "method": "lingbot_map_stream_sdpa_v118_r78_fresh_leaveout35_g1p25_seq08",
        "policy": "R78_FRESH_LEAVEOUT35_G1P25",
        "source_frames": (0, 1, 2, 4),
        "token_weight_mode": "risk_suppress_only_g1p25_x_frame",
    },
    {
        "role": "leaveout35_g1p5",
        "method": "lingbot_map_stream_sdpa_v118_r78_fresh_leaveout35_g1p5_seq08",
        "policy": "R78_FRESH_LEAVEOUT35_G1P5",
        "source_frames": (0, 1, 2, 4),
        "token_weight_mode": "risk_suppress_only_g1p5_x_frame",
    },
]
...
def build_configs() -> list[dict[str, Any]]:
    ...
    config = CONFIG_DIR / "kitti_lingbot_sdpa_v118_r78_stronger_risk_source_refinement_seq08.yaml"
    ...
    for gpu, spec in enumerate(METHOD_SPECS):
        ...
        method_rows.append(
            {
                "schema": "acl2_v118tf_stage4_r78_stronger_risk_method_row_v1",
                "seq": SEQ,
                "dataset": DATASET,
                "role": spec["role"],
                "method": method,
        ...
        manifest_rows.append(
            {
                "schema": "acl2_v118tf_stage4_r78_stronger_risk_run_manifest_row_v1",
                "phase": "cleanup_trace",
                "seq": SEQ,
                "dataset": DATASET,
                "method": method,
    ...
    write_csv(SUMMARY_DIR / "stage4_r78_stronger_risk_method_rows.csv", method_rows)
...
def summarize(method_rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    for spec in method_rows:
        ...
        row = {
            "schema": "acl2_v118tf_stage4_r78_stronger_risk_result_row_v1",
            "seq": SEQ,
            "dataset": DATASET,
            "role": spec["role"],
            "method": method,
    ...
    decision = "R78_CONFIG_READY_NOT_RUN"
    if complete:
        if best.get("geometry_gate") and best.get("better_than_r77_best") and best.get("better_than_r71_original_random"):
            decision = "R78_STRONGER_RISK_GEOMETRY_CANDIDATE_FOUND_REQUIRES_MATCHED_CONTROLS"
        elif best.get("better_than_r77_best"):
            decision = "R78_STRONGER_RISK_IMPROVES_R77_BUT_GATE_OR_RANDOM_STILL_FAILS"
        else:
            decision = "R78_STRONGER_RISK_NO_REPAIR"
    summary = {
        "schema": "acl2_v118tf_stage4_r78_stronger_risk_summary_v1",
        "stage4_r78_decision": decision,
        "complete": complete,
        "global_goal_achieved": False,
        "claim_level": "fresh_seq08_stronger_risk_search_only",
        ...
        "result_rows": rows,
        "outputs": {
            "summary": rel(SUMMARY_DIR / "stage4_r78_stronger_risk_summary.json"),
            "rows": rel(SUMMARY_DIR / "stage4_r78_stronger_risk_rows.csv"),
            "method_rows": rel(SUMMARY_DIR / "stage4_r78_stronger_risk_method_rows.csv"),
            "run_manifest": rel(STAGE / "run_manifest.csv"),
        },
    }
    write_csv(SUMMARY_DIR / "stage4_r78_stronger_risk_rows.csv", rows)
    write_json(SUMMARY_DIR / "stage4_r78_stronger_risk_summary.json", summary)
    return summary
