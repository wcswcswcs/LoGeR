#!/usr/bin/env python3
"""ACL2 v26 fine-label semantic role router hard-gate audit.
...
def _phase0_noop_gate(results_root: Path, prefix: str, chunk: int, horizon: int) -> Dict[str, object]:
    reference = _phase0_run_dir(results_root, prefix, "P0_00_H9_REFERENCE", chunk, horizon) / "01.txt"
    rows: List[Dict[str, object]] = []
    ...
    for candidate in PHASE0_CANDIDATES[:4]:
        ...
        row = {
            ...
            "reference_candidate_id": "P0_00_H9_REFERENCE",
...
def main() -> int:
    ...
    parser.add_argument("--phase0-prefix", default="V26_P0_SMOKE_R1")
    ...
    summary: Dict[str, object] = {
        "phase": "v26_phase0_fine_label_path_router_audit",
        "uses_gt_semantic": False,
    ...
    report = [
        "# ACL2 v26 Fine-Label Path Router Phase-0 Audit",
        "",
