#!/usr/bin/env python3
"""Run ACL2 v78 Phase 2 L07-to-L13 two-stage read-control jobs."""
...
DEFAULT_OUTPUT_ROOT = Path(
    ...
    "report_final/phase2_l07_l13_twostage/rollouts"
)
...
CASES: Dict[str, Dict[str, str]] = {
    "G0_BASE": {"read_path": "none", "enable_frame_read_control": "0", "cue": "dyn"},
    "G1_L13_ONLY": {"read_path": "frame", "enable_frame_read_control": "1", "cue": "v78.l07_l13.l13_only"},
    "G2_L07_ACTION_ONLY": {"read_path": "frame", "enable_frame_read_control": "1", "cue": "v78.l07_l13.l07_action_only"},
    "G3_L07_MASK_L13_NEG": {"read_path": "frame", "enable_frame_read_control": "1", "cue": "v78.l07_l13.l07_mask_l13_neg"},
    "G4_L07_MASK_L13_STABLE": {"read_path": "frame", "enable_frame_read_control": "1", "cue": "v78.l07_l13.l07_mask_l13_stable"},
    "G5_L07_MASK_L13_NEG_PLUS_STABLE": {
        "read_path": "frame",
        "enable_frame_read_control": "1",
        "cue": "v78.l07_l13.l07_mask_l13_neg_plus_stable",
    },
    "G6_L07_MASK_L13_CONTRAST": {"read_path": "frame", "enable_frame_read_control": "1", "cue": "v78.l07_l13.l07_mask_l13_contrast"},
    "G3_RANDOM_SAME_MASS": {"read_path": "frame", "enable_frame_read_control": "1", "cue": "v78.l07_l13.l07_mask_l13_neg.random_same_mass"},
    "G3_RANDOM_GROUP_STRATIFIED": {
        "read_path": "frame",
        "enable_frame_read_control": "1",
        "cue": "v78.l07_l13.l07_mask_l13_neg.group_stratified_random",
    },
}
...
def main() -> None:
    ...
    manifest_path = args.output_root / "phase2_l07_l13_run_manifest.json"
