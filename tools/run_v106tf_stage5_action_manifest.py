#!/usr/bin/env python3
"""Run selected ACL2 v106 Stage5 LingBot runtime manifest rows."""
...
STAGE5 = ROOT / "results/acl2_v106tf_lingbot_semantic_aware_memory_role_control/stage5_query_head_local_minimization"
MANIFEST = STAGE5 / "run_manifest.csv"
RESULTS_CSV = STAGE5 / "run_results.csv"
RESULTS_JSONL = STAGE5 / "run_results.jsonl"
...
def main() -> None:
    ...
    for row in selected:
        ...
        result = {
            "schema": "acl2_v106tf_stage5_runtime_run_result_v1",
            ...
            "control_for": row.get("control_for", ""),
            "promotion_eligible": row.get("promotion_eligible", ""),
            "stage5_action_mode": row["stage5_action_mode"],
