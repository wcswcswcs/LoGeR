#!/usr/bin/env python3
"""Run selected ACL2 v105-TF LingBot Stage 4 manifest rows."""
...
STAGE4 = ROOT / "results/acl2_v105tf_dualtrack_lingbot_loger_evidence_eligibility/stage4_lingbot_action_pilot_or_blocked"
...
def main() -> None:
    ...
    parser.add_argument("--actions", default="", help="Comma-separated action labels; empty means all.")
    ...
    selected = [
        row for row in rows
        if (not actions or row["action_label"] in actions)
    ...
    for row in selected:
        ...
        result = {
            "schema": "acl2_v105tf_lingbot_stage4_run_result_v1",
